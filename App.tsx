      ...
      <ScrollView>
        ...
        <View style={styles.product}>
          ...
          <View style={styles.detalle}>
            <Text style={styles.t1}>Aldo</Text>
            <Text style={styles.t2}>Almond Toe</Text>
            <Text style={styles.t3}>Size: 39 us</Text>
        ...
        <View style={styles.product}>
          ...
          <View style={styles.detalle}>
            ...
            <View style={styles.price}>
              ...
              <Text style={styles.AED2}>AED 45</Text>
            </View>
          </View>
          <View style={styles.btn}>
            <AntDesign name="plus" style={styles.plus}/>
